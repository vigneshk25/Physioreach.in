            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="relative w-[130px] h-[50px]">
                <input 
                  ...
                  <label 
                    htmlFor="customFile"
                    className='absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46]
              ...
              <div className="mt-7">
                  <button type="submit" className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-4">
                    Sign Up
                  </button>
                </div>
